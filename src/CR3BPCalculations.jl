...
"""
nondimensional_radii(r::AbstractVector, xᵢ) = √( (r[1]-xᵢ)^2 + r[2]^2 + r[3]^2 )
...
"""
potential_energy(r, μ) = (r[1]^2 + r[2]^2)/2 + ((1-μ)/nondimensional_radii(r,-μ)) + (μ/nondimensional_radii(r,1-μ))
...
- [Rund, 2018](https://digitalcommons.calpoly.edu/theses/1853/).
"""
function analytical_halo(μ; Az=0.00, ϕ=0.0, steps=1,
...
"""
function zero_velocity_curves(r::AbstractVector, v::AbstractVector, μ::Real;
